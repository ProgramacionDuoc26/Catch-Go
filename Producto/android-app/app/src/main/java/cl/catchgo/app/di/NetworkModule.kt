...
import cl.catchgo.app.data.remote.LocalhostMappingInterceptor
...
object NetworkModule {
    ...
    fun provideOkHttpClient(
        ...
        localhostMappingInterceptor: LocalhostMappingInterceptor,
        loggingInterceptor: HttpLoggingInterceptor
    ): OkHttpClient = OkHttpClient.Builder()
        .addInterceptor(authInterceptor)
        .addInterceptor(localhostMappingInterceptor)
    ...
    @Provides
    @Singleton
    fun provideHabilidadesApi(@Named("auth") retrofit: Retrofit): HabilidadesApi =
        retrofit.create(HabilidadesApi::class.java)

    @Provides
    @Singleton
    @Named("profile")
    fun provideProfileRetrofit(client: OkHttpClient, json: Json): Retrofit = Retrofit.Builder()
        .baseUrl(ApiConfig.PROFILE_URL)
        .client(client)
        .addConverterFactory(json.asConverterFactory("application/json".toMediaType()))
        .build()
