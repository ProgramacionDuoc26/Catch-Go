...
public class JobOfferController {
    ...
    public com.catchandgo.jobs.dto.JobApplicationDto apply(@org.springframework.web.bind.annotation.PathVariable("id") Long id, @org.springframework.web.bind.annotation.RequestParam("userId") String userId) {
        return service.apply(id, userId);
    }
