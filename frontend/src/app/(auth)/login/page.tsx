              ...
              <div className="mt-10">
                ...
                <div className="mt-8">
                  <button
                    ...
                    className="w-full flex justify-center items-center py-4 px-6 border border-slate-200 rounded-2xl shadow-sm text-sm font-bold text-slate-700 bg-white hover:bg-slate-50 transition-all min-h-[56px]"
                  >
