...
export function calculateMatchScore(workerProfile: any, companyProfile: any, jobOffer: any): MatchScore {
  let score: MatchScore = {
    total: 0,
    breakdown: { habilidades: 0, experiencia: 0, distancia: 0, disponibilidad: 0 }
  };
  ...
  // Total
  score.total = score.breakdown.habilidades + score.breakdown.experiencia + score.breakdown.distancia + score.breakdown.disponibilidad;
